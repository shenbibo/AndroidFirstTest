...
public class RxJavaThreadSchedulerTest2 {

    private static final String TAG = "RxJavaThreadTest";

    @org.junit.Test
    public void testDoInSubThreadAndCallbackInMainThread() {
     ...
     */
    @org.junit.Test
    public void testDoInSubThreadAndObserveOnFunctionContinueCallThreeTimes() {
        Observable<String> stringObservable = Observable.create(e -> {
            Log.i(TAG, "current thread = " + Thread.currentThread().getName());
     ...
     */
    @org.junit.Test
    public void testDoInSubThreadAndCallObserveOnMethodDiscrete() {
        ...
        // doOnXXX 方法其实就是一个普通的操作符，它可以改变对象的属性，但是却不能改变对象的类型，也不能将对象指向一个新的对象
